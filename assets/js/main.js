...
/* MENU SHOW */
/* valida se constante existe ~ validate if constant exists */
if (navToggle) {
...
/* MENU HIDDEN */
/* valida de constante existe ~ validate if constant exists */
if (navClose) {
...
const linkAction = () => {
    ...
    // we remove the show-menu ~ Quando clicarmos em um item de navegação remove o menu
    navMenu.classList.remove('show-menu');
}
...
const scrollHeader = () => {
    ...
    // quando o scroll for maior que 50 viewport height, adicione a classe scroll-header
